...
description: "Trust framework ensuring agents trust completed prerequisite work and leverage validation safeguards (Acceptance Criteria, Success Indicators) without re-analysis"
applies_to:
  - "**/*"
domains:
  - "trust_execution"
