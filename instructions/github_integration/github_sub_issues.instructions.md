...
description: "Comprehensive sub-issues standards for multi-step execution tracking with automatic progress calculation and bidirectional API navigation"
applies_to:
  - "**/*.md"
  - ".github/**/*"
domains:
...
priority: "P1"
patterns:
  - "api_navigation_patterns"
  - "systematic_prevention"
  - "context_first_philosophy"
