...
description: "Essential GitHub operations, project management, issue lifecycle, multi-dimensional completion verification, and machine-readable tracking for agentic workflows"
applies_to:
  - "**/*.md"
  - ".github/**/*"
domains:
