...
description: "Essential validation standards for quality gates, testing, and completion criteria in agent-first architecture."
applies_to:
  - "tests/**"
  - "scripts/validation/**"
  - ".github/workflows/**"
...
priority: "P1"
patterns:
  - "deterministic_validation_agents"
