---
title: "Token Usage and Context Window Management"
description: "Principles for managing token usage focusing on context window preservation rather than cost optimization"
applies_to:
  - "**/*.md"  # All work affects token usage
  - "knowledge/instructions/**"  # Instruction file verbosity
  - "docs/**"  # Documentation completeness
  - "wiki/**"  # Wiki page depth
domains:
  - "development"
  - "quality"
  - "agent_operations"
priority: "P1"  # Core - affects agent operational capability
patterns:
  - "context_window_preservation"
  - "quality_over_cost_optimization"
