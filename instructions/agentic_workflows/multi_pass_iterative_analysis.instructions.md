---
title: "Multi-Pass Iterative Analysis Pattern"
description: "Structured methodology for analyzing collections of items with N-to-N cross-referencing to ensure completeness and correctness"
applies_to:
  - "**/*.md"  # Any analysis/gardening work
  - "docs/project_management/**"  # PI gardening, issue triage
domains:
  - "analysis"
  - "project_management"
  - "quality"
priority: "P1"
patterns:
  - "multi_pass_iterative_analysis"
  - "n_to_n_cross_referencing"
  - "cluster_first_analysis"
