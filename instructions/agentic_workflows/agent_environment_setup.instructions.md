---
title: "Agent Environment Setup Standards"
description: "Development environment and tooling standards ensuring zero-configuration bootstrap, structured output, and graceful failures for AI agent compatibility"
applies_to:
  - "**/.devcontainer/**"
  - "**/docker-compose*.yml"
  - "**/.github/workflows/**"
...
priority: "P0"
patterns:
  - "agent_first_design_checklist"
  - "agentic_workflows"
  - "configuration_first_philosophy"
