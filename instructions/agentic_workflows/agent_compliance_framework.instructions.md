...
description: "Systematic compliance checks ensuring agents follow explicit user instructions, institutional policies, and established processes without unauthorized substitutions or shortcuts. Includes enforcement mechanisms requiring compliance evidence."
applies_to:
  - "**/*"  # All agent work requires compliance validation
domains:
  - "agentic_workflows"
  - "quality"
  - "trust_execution"
priority: "P0"  # Foundation - compliance is prerequisite for all work
routing:
  priority: 1
  triggers:
    keywords:
...
patterns:
  - "trust_verify_principle"
  - "complete_context_principle"
related_instructions:
  - "trust_execution/trust_based_task_execution.instructions.md"
  - "validation/validation_first_execution.instructions.md"
