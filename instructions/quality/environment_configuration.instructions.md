...
description: "Comprehensive environment configuration management including .env patterns, config validation, secrets management, and environment-specific settings"
applies_to:
  - "**/.env*"
  - "**/config/**/*"
  - "**/*.config.ts"
