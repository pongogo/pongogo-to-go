...
| `/pongogo-log` | Create a work log entry |
| `/pongogo-retro` | Run a retrospective/learning loop |
| `/pongogo-done` | Completion checklist for finishing work |
| `/pongogo-rca` | Root cause analysis wizard |
...
- **Report an issue** → https://github.com/pongogo/pongogo-to-go/issues
